    ...
    async with SessionLocal() as session:
        ...
        try:
            ...
            system_prompt = (
                ...
                "请根据提供的小说正文，输出一份不超过 200 字的小说【简介/概括】，用于展示给读者。"
                "简介需包含：1) 小说主人公是谁；2) 小说的核心设定与总体情节走向。"
                "【重要约束】这是「概括/简介」任务，严禁续写剧情、严禁生成任何故事后续内容，"
                "只能总结已有正文。直接输出概括文本，不要分点、不要换行、不要加任何前缀或解释。"
                "示例输出：少年林尘天生残脉无法修炼，却意外获得神秘传承，自此踏上逆天改命、征战诸天的修行之路。"
            )
